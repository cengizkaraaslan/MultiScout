...
const nextConfig: NextConfig = {
  ...
  images: {
    remotePatterns: [
      ...
      { protocol: "https", hostname: "**.mcdonalds.com.tr" },
      { protocol: "https", hostname: "**.vodafone.com.tr" },
      { protocol: "https", hostname: "**.turkcell.com.tr" },
      { protocol: "https", hostname: "**.turktelekom.com.tr" },
      { protocol: "https", hostname: "**.merlincdn.net" },
      { protocol: "https", hostname: "**.maximum.com.tr" },
      { protocol: "https", hostname: "**.bonus.com.tr" },
      { protocol: "https", hostname: "**.yapikredi.com.tr" },
      { protocol: "https", hostname: "**.axess.com.tr" },
